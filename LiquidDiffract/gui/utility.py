...
class AboutDialog(QDialog):
    def __init__(self):
        ...
        _description = ('LiquidDiffract is a graphical data analysis '
                        'application for processing experimental total X-ray '
                        'diffraction data of liquids and disordered solids. '
                        ...
                        'structure factor, and estimation of sample density. '
                        'It implements procedures to obtain information on '
                        'macroscopic bulk properties (density) and local '
                        'atomic arrange (pair distribution function, g(r)) '
                        'from total XRD data.'
                        )
        ...
        _copyright = 'Copyright &copy; 2019 &ndash; Benedict J. Heinen'
